;(function(window) {
	...
	function loadNextItems() {
		...
		setTimeout(function() {
			...
			//var dummyContent = '<li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/10.jpg" alt="Some image" /><h3 class="grid__item-title">脆皮芝士</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/11.jpg" alt="Some image" /><h3 class="grid__item-title">抹茶塔</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/12.jpg" alt="Some image" /><h3 class="grid__item-title">可丽饼卷</h3></a></li>';
			var dummyContent = '<li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/10.jpg" alt="Some image" /><h3 class="grid__item-title">柠檬水</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/11.jpg" alt="Some image" /><h3 class="grid__item-title">缤纷果汁</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/12.jpg" alt="Some image" /><h3 class="grid__item-title">三杯果汁（套餐）</h3></a></li>';
