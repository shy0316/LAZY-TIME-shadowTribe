;(function(window) {
	...
	function loadNextItems() {
		...
		setTimeout(function() {
			...
			var dummyContent = '<li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/icecream/10.jpg" alt="Some image" /><h3 class="grid__item-title">奶糖咖啡</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/icecream/11.jpg" alt="Some image" /><h3 class="grid__item-title">卡布奇诺-抹茶</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/icecream/12.jpg" alt="Some image" /><h3 class="grid__item-title">卡布奇诺3号</h3></a></li>';
