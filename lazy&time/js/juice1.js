;(function(window) {
	...
	function loadNextItems() {
		...
		setTimeout(function() {
			...
			var dummyContent = '<li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/10.jpg" alt="Some image" /><h3 class="grid__item-title">Lemon Water</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/11.jpg" alt="Some image" /><h3 class="grid__item-title">Colorful Juice</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/juice/12.jpg" alt="Some image" /><h3 class="grid__item-title">Three Cup Of Juice(package)</h3></a></li>';
