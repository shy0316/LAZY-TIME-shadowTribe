;(function(window) {
	...
	function loadNextItems() {
		...
		setTimeout(function() {
			...
			var dummyContent = '<li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/milktea/10.jpg" alt="Some image" /><h3 class="grid__item-title">Cripsy Cheese</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/milktea/11.jpg" alt="Some image" /><h3 class="grid__item-title">Matcha Tower</h3></a></li><li class="grid__item grid__item--hidden"><a class="grid__link" href="#"><img class="grid__img" src="img/milktea/12.jpg" alt="Some image" /><h3 class="grid__item-title">Crepes Roll</h3></a></li>';
